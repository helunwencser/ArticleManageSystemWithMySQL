...
public class ListPublicationOfAuthor extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "select distinct title from article_author_table where author = '" + author + "';";
            Statement stmt = con.createStatement();
            ResultSet res = stmt.executeQuery(query);
            List<String> articles = new ArrayList<String>();
            while(res.next())
            	articles.add(res.getString("title"));
            out.println("Details of all publications of " + author + ":<br>");
